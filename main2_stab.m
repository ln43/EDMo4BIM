% Main Partie 2
% Representation des solutions stables grace a Stable.m
...
% Simulations des solutions en fonction de c3
i=1;
for c3=linspace(-10,10,3) 
    ...
    %Representation de p en fonction de t et a pour differents c3 pris
    figure(1)
    subplot(2,3,i)
    ...
    %Representation de r en fonction de t et a pour differents c3 pris
    %figure(2)
    subplot(2,3,i+3)
